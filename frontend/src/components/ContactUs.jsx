            ...
            <div className='px-8 py-10'>
              ...
              >
                <input
                  ...
                  required
                  className='w-full border-b border-gray-500 focus:border-gray-800 outline-none py-2
             ...
             bg-transparent text-black placeholder-gray-400'
                ...
                <button
                  ...
                  className='w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-medium mt-6 py-2 px-4 rounded-md transition duration-200 uppercase'
                >
                  {status.loading
                    ? 'Subscribing...'
                    : 'Subscribe'}
